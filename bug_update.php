...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	foreach( $t_related_custom_field_ids as $t_id ) {
      ...
      //jdholguin - se agrega el if para verificar que si es un actualizador o menos,
     //se deja igual el valor de los campos 5, 2 y 9 correspondientes al área, correo y extensión
         if (current_user_get_access_level() <= UPDATER){
              if( $t_id == 5 || $t_id == 2 || $t_id == 9 ){
                  continue;
               }
          }
         //fin jdholguin
