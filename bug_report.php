...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
    ...
    // Agregué la condición if($t_def['require_report'])
      if ( $t_def['require_report'] && !custom_field_validate( $t_id, gpc_get_custom_field( "custom_field_$t_id", $t_def['type'], NULL ) ) ) {
        error_parameters( lang_get_defaulted( custom_field_get_field( $t_id, 'name' ) ) );
    ...
    // aorozco 2013-06-06
    // modifiqué validación segun http://www.mantisbt.org/bugs/view.php?id=11684#c28260
