...
<!-- Modificado para ocultar en la impresión de casos de PFSGYC -->
<?php if($t_project_name != "PFSGYC"){?>
	<td class="form-title" colspan="6">
<?php }else{ ?>
	<td class="form-title" colspan="4">
<?php }// END else($t_project_name != "PFSGYC") ?>
...
<?php }else{ ?>
	<td class="print-spacer" colspan="4">
<?php }// END else($t_project_name != "PFSGYC") ?>
		<hr size="1" width="100%" />
	</td>
</tr>
...
<?php }// END if($t_project_name != "PFSGYC") ?>
	<td class="print" width="16%">
...
<?php if($t_project_name != "PFSGYC"){?>
	<td class="print-spacer" colspan="6">
<?php }else{// END if($t_project_name != "PFSGYC")} ?>
	<td class="print-spacer" colspan="4">
<?php }// END if($t_project_name != "PFSGYC") ?>
		<hr size="1" width="100%" />
	</td>
...
<?php # Bugnotes END ?>
<!-- rjaramillo 2011-12-01 -->
<!-- Agregado para la impresión de casos de PFSGYC -->
<?php if($t_project_name == "PFSGYC"){?>
<table width="100%">
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td class="print"><b>Fecha de entrega: </b></td>
    <td>________________________________</td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td class="print"><b>Hora de entrega: </b></td>
    <td>________________________________</td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td class="print"><b>Firma Auxiliar: </b></td>
    <td>________________________________</td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td class="print"><b>Firma Recibido (Oficina): </b></td>
    <td>________________________________</td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td class="print"><b>Observaciones del servicio: </b></td>
...
________________________________________________________________
  ...
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td colspan="2" class="print">
      <b>RECUERDE DILIGENCIAR COMPLETAMENTE LA INFORMACIÓN DE LA ORDEN DE SERVICIO Y NO OLVIDE DEVOLVER EL DOCUMENTO EN BUEN ESTADO Y EN LOS 
         TIEMPOS ACORDADOS PARA ELLO.</b>
    </td>
  </tr>
</table>
<?php }// END if($t_project_name == "PFSGYC"){?>
