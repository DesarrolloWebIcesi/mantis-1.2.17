		...
		if ( $f_action === 'CUSTOM' ) {
			...
			switch ( $f_action ) {
				...
				case 'UP_PRIOR':
					...
					break;
				case 'UP_STATUS':
                 //jlozano 15-06-2012 si el rol del usuario es el de aprobador (UPDATER) entonces muestre la lista de cambiar estado de los aprobadores
                    if ( current_user_get_access_level() > UPDATER){
                        ...
                        print_enum_string_option_list( 'updater_status', config_get( 'bug_submit_status' ) );
                     }        
                  //fin jlozano
                 break;
				case 'UP_CATEGORY':
