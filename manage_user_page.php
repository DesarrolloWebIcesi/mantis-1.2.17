...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	/* Se modifico la función gpc_get_string cambiando el parametro username a realname
	autor: cdcriollo
	fecha: Octubre 16 2014
	*/
	$f_sort          = gpc_get_string( 'sort', 'realname' );
	...
	if ( $f_filter === 'ALL' ) {
		...
		/* Se modifico la clausula where para que filtrara por el realname 
		  autor: cdcriollo
		  fecha: Octubre 16 2014
	    */
