...
if ( $tpl_show_id || $tpl_show_project || $tpl_show_category || $tpl_show_view_state || $tpl_show_date_submitted | $tpl_show_last_updated ) {
    ...
    */
	...
	# Date Submitted
	echo '<td>', $tpl_show_date_submitted ? str_replace($mes_ingles, $mes_espanol, date( config_get( 'normal_date_format' ), $tpl_bug->date_submitted )) : '', '</td>';

	# Date Updated
	echo '<td>', $tpl_show_last_updated ? str_replace($mes_ingles, $mes_espanol, date( config_get( 'normal_date_format' ), $tpl_bug->last_updated )) : '', '</td>';
