...
/* rjaramillo 2011-12-01 
 Documentado para NO permitir seleccionar el proyecto por defecto */
...
<!-- rjaramillo 2011-12-01 -->
<!-- Agregado para seleccionar el proyecto en la interfaz de reporte de casos -->


  <tr class="row-1">
    <td class="category">
      <span class="required">*</span><?php echo lang_get( 'choose_project' ) ?>
    </td>
    <td>
      <select name="project_id">
      <!-- aorozco 2013-06-06 -->
      <!-- Se modificó el parámetro ALL_PROJECTS por helper_get_current_project() para que seleccione el proyecto actual -->
      <?php print_project_option_list( helper_get_current_project(), false, null, true ) ?>
      </select>
    </td>
  </tr>
...
<!-- Modificado para validar el correo con JavaScript. Caso SGS: 62281 -->
<!-- Le agregué: onClick="return isEmailAddress(document.report_bug_form.custom_field_2)" -->
<!--			<input <?php /* echo helper_get_tab_index() */?> type="submit" class="button" value="<?php /*echo lang_get( 'submit_report_button' )*/ ?>" />-->
			<input <?php echo helper_get_tab_index() ?> type="submit" class="button" value="<?php echo lang_get( 'submit_report_button' ) ?>" onClick="return isEmailAddress(document.report_bug_form.custom_field_2)" />
		</td>
	</tr>
</table>
</form>
